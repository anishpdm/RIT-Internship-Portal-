...
export default async function EvaluatePage({
  ...
  return (
    <>
      ...
      <h2 className="font-display text-2xl mb-4">Evaluate</h2>
      <form action={gradeSubmission} className="card max-w-2xl space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button type="submit" name="action" value="review" className="btn btn-ghost">
            Mark under review
          </button>
          <button type="submit" name="action" value="return" className="btn btn-ghost">
            Return to student
          </button>
        </div>
      </form>
