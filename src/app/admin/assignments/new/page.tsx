...
async function createAssignment(formData: FormData) {
  ...
  if (!internship_id || !title)
    redirect('/admin/assignments/new?error=missing');
      ...
      <form action={createAssignment} className="card max-w-3xl space-y-5">
        ...
        <div className="flex flex-col gap-2">
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" name="allow_github" defaultChecked />
            Allow GitHub URL submission
          </label>
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" name="allow_file_upload" defaultChecked />
